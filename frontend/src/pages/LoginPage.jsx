        ...
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden transition-colors duration-300">
            ...
            >
                ...
                <div className="text-center mb-6 md:mb-8 mt-6 md:mt-0">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-2">Enter your classroom dashboard</p>
                </div>
                ...
                <div className="flex bg-gray-100 dark:bg-black/40 p-1 rounded-xl mb-6">
                    <button
                        ...
                        className={`flex-1 py-2 rounded-lg text-sm font-bold transition-all ${role === 'student' ? 'bg-purple-600 text-white shadow-lg' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white'}`}
                    >
                        Student
                    </button>
                    <button
                        ...
                        className={`flex-1 py-2 rounded-lg text-sm font-bold transition-all ${role === 'teacher' ? 'bg-cyan-600 text-white shadow-lg' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white'}`}
                    >
                        Teacher
                    </button>
                </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                type="email"
                                required
                                className={`w-full bg-gray-50 dark:bg-black/40 border border-gray-300 dark:border-white/10 rounded-xl px-12 py-3.5 focus:outline-none focus:border-${role === 'student' ? 'purple' : 'cyan'}-500 text-gray-900 dark:text-white transition-colors`}
                ...
                <p className="mt-8 text-center text-gray-600 dark:text-gray-400 text-sm">
                    New here? <Link to="/signup" className="text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 transition-colors underline font-medium">Create a {role === 'student' ? 'Student' : 'Teacher'} Account</Link>
                </p>
            </motion.div>
        </div>
    )
